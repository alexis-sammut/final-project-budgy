...
# Define frequency choices, reuse in pocket and item models
FREQUENCY_CHOICES = [
    ('daily', 'Daily'),
    ('weekly', 'Weekly'),
...
ITEM_FREQUENCY_CHOICES = FREQUENCY_CHOICES + [
    ('percentage', 'Ratio'),
]
...
class Item(models.Model):
    ...
    amount = models.DecimalField(max_digits=20, decimal_places=10, default=0)
    amount_display = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    frequency = models.CharField(max_length=10, choices=ITEM_FREQUENCY_CHOICES, default='monthly')
...
class SortedPocket(models.Model):
    ...
    sorted_income = models.ForeignKey(SortedIncome, on_delete=models.CASCADE, related_name='sorted_pockets')
